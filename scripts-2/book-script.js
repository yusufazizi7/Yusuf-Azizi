...
document.querySelectorAll(".product-page").forEach((productPage) => {
    ...
    /* =====================================================
       GET ACTIVE PREVIEW GROUP
       ===================================================== */

    function getActivePreviewGroup() {

        return productPage.querySelector(
            ".ebook-preview-group.active"
        );

    }


    function getActiveThumbnails() {

        const activeGroup =
            getActivePreviewGroup();
        ...
        (button) => {
            ...
            button.addEventListener(
                ...
                () => {
                    ...
                    /*
                     * Every format begins on
                     * preview-01.
                     */

                    activeThumbnails.forEach(
                        (thumbnail) => {
